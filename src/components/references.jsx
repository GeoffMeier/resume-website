        ...
        <table className=" table-auto max-auto border-separate    border-spacing-0  ">
          ...
          <tbody>
            <tr className="text-center border-separate border border-blue-500">
              <td class="text-xl border-t-2     border-b-2 border-blue-500 py-6 pl-8 pr-8">
                Gavin Meier
              </td>
              <td class="text-xl border-t-2 border-b-2 border-blue-500 py-6 pl-8 pr-8">
              ...
              <td class="text-xl border-t-2 border-b-2 border-blue-500 py-6">
                Mentor
              </td>
            </tr>
            <tr className="text-center">
              <td class="text-xl  border-b-2 border-blue-500 py-6 pl-8 pr-8">
                Lucas Barth
              </td>
              <td class="text-xl  border-b-2 border-blue-500 py-6 pl-8 pr-8">
                Senior Software Engineer{" "}
            ...
            <tr className="text-center border-b border-blue-500">
              ...
              <td class="text-xl  border-b-2 border-blue-500 py-6 pl-8 pr-8">
                Teacher Assistant at LaunchCode
              </td>
            </tr>
            <tr className="text-center">
              <td class="text-xl border-b-2 border-blue-500 py-6 pl-8 pr-8 ">
