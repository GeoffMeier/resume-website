  ...
  return (
    <>
      ...
      <div className="pt-6 grid grid-cols-2  divide-x-2 outline-blue-500 ">
        <div className="">
          ...
          <div className="text-center pl-9 py-4">
            {" "}
            <span className=" text-xl tracking-wide">
              - St. Louis Community College, Associate in Arts - May 2022
            </span>
          </div>

          <div className=" text-center py-4  pt-10 font-sans font-bold  decoration-neutral-800 text-3xl  tracking-widest underline   underline-offset-8 ">
            Skills
          </div>
          <div className="text-center text-xl text-blue-500 font-bold tracking-wider">
            {" "}
            <span className="italic">Programming Languages & tools</span>
          </div>
          <div className=" text-xl pt-1 text-center tracking-wide">
            {" "}
          ...
          <div className=" text-xl text-center pt-1 tracking-wide">
            {" "}
            - <span className="italic">Spring</span>
          </div>
          <div className=" text-xl text-center pt-1 tracking-wide">
            {" "}
    ...
    <li>Iterated over questions to display one question at a time and stored candidate’s answers
          ...
          <div className="pt-8 flex flex-row item-center text-center">
            <div className=" pt-4  pl-28 item-center text-center">
              <a className="  text-5xl" href="https://www.java.com/en/">
                <BiLogoJava />{" "}
              </a>
            </div>
            <div className="pl-8 pt-4">
              <a className=" text-5xl" href="https://www.javascript.com/">
                <BiLogoJavascript />
              </a>
            </div>
            <div className="pl-8 pt-4">
              <a className="   text-5xl" href="https://react.dev/">
                <BiLogoReact />
              </a>
            </div>
            <div className="pl-8 pt-4">
              <a className="   text-5xl" href="https://spring.io/">
                <BiLogoSpringBoot />
              </a>
            </div>
            <div className="pl-8 pt-4">
              <a className="   text-5xl" href="https://angular.io/">
                <BiLogoAngular />
              </a>
            </div>
            <div className="pl-8 pt-4">
              <a className="   text-5xl" href="https://nodejs.org/en">
                <BiLogoNodejs />
              </a>
            </div>
            <div className="pl-8 pt-4">
              <a className="   text-5xl" href="https://css.com/">
                <BiLogoCss3 />
              </a>
            </div>
            <div className="pl-8 pt-4">
              <a className="   text-5xl" href="https://html.com/">
                <BiLogoHtml5 />
              </a>
            </div>
          </div>
